    ...
    ngOnInit() {
        ...
        for (index in this.userprivileges) {
            if (this.userprivileges[index].parentPrivilegeId == null) {
                    ...
                    for (i in this.userprivileges) {
                        if (this.userprivileges[i].parentPrivilegeId != null) {
                            if (this.userprivileges[i].parentPrivilegeId == this.userprivileges[index].id) {
                                items.push({
                                    label: this.userprivileges[i].englishName,
                    ...
                    if (items.length == 0) {
                        this.model.push({
                            label: this.userprivileges[index].englishName,
        ...
        //     {
        //         label: 'Event', icon: 'pi pi-fw pi-calendar-plus', routerLink: ['/event'],
        //         items: [
        //             {label: 'Add Event', icon: 'pi pi-fw pi-calendar-plus', routerLink: ['/event']}
        //         ]
        //     },
        //     {
        //         label: 'User', icon: 'pi pi-user', routerLink: ['/user'],
        //         items: [
        //             {label: 'Add User', icon: 'pi pi-fw pi-id-card', routerLink: ['/user']}
        //         ]
        //     },
        //     {
