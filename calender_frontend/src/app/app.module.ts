...
import { ConfirmEqualValidatorsDirective } from './change-password/ConfirmEqualValidatorsDirective';
...
@NgModule({
    ...
    providers: [
        {provide: LocationStrategy, useClass: PathLocationStrategy},WebSocketService,
        {provide: HTTP_INTERCEPTORS, useClass: TokenInterceptorService, multi: true},
        CountryService, CustomerService, EventService, IconService, NodeService,DatePipe,
        PhotoService, ProductService, MenuService, BreadcrumbService,MessageService,AuthGuard
    ],
